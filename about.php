				...
				<div class="main-text">
					...
					<p>Hi! I'm a firm believer in living life with optimism and kindness,
						...
						<ul>
							...
							<li>promoting equal opportunity</li>
							<li>breaking stereotypes</li>
							<li>having respect and compassion for all life forms</li>
							<li>practicing nonviolent communication</li>
							<li>encouraging moral reflection and consistency</li>
						...
						<p>Right now, I'm living in and loving Minneapolis, MN, USA.
							...
							I'm currently working at the Walker Art Center and Highpoint Center for Printmaking,
						...
						<p>I grew up in Hong Kong with TCKs
							...
							things accessible. This site is actually under
							development for that, so excuse any weird bugs.
